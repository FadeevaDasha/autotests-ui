...
with sync_playwright() as playwright:
    ...
    title_empty_list = page.get_by_test_id('courses-list-empty-view-title-text')
    expect(title_empty_list).to_be_visible()
    expect(title_empty_list).to_have_text("There is no results")

    icon_empty_list = page.get_by_test_id('courses-list-empty-view-icon')
    expect(icon_empty_list).to_be_visible()

    description_empty_list = page.get_by_test_id('courses-list-empty-view-description-text')
